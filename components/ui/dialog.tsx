...
>(({ className, ...props }, ref) => {
  ...
  return (
    <DialogPrimitive.Overlay
      className={cn(
        "absolute bottom-0 left-0 right-0 top-0 flex items-center justify-center bg-gray-500/50 p-2",
        open
    ...
    <DialogPortal hostName={portalHost}>
      <DialogOverlay>
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            "max-w-lg gap-4 rounded-lg border border-border bg-background p-6 shadow-lg",
            open
        ...
        >
          ...
          <DialogPrimitive.Close
            className={"absolute right-4 top-4 rounded-sm p-0.5 opacity-70"}
          >
            <X
